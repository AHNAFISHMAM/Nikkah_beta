    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background via-70% to-islamic-purple/5">
      ...
      <header className="sticky top-0 z-50 border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 safe-area-inset-top">
        <div className="container flex h-14 sm:h-16 items-center justify-between gap-2 px-3 sm:px-4 lg:px-6">
              <Link to="/home" className="flex items-center gap-1.5 sm:gap-2 hover:opacity-80 transition-opacity touch-target-sm shrink-0" aria-label="Go to home page">
                <img
                  src="/logo.png"
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 z-50 safe-area-inset-bottom safe-area-inset-left safe-area-inset-right">
